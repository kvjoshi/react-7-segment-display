...
const Digit = ({ char, // No default needed here, logic below handles invalid/missing char
color = "red", height = 250, skew = false, charMap = charToDigit_1.default, // Use the default map if none is provided via props
 }) => {
    const style = {
        height: `${height}px`,
        width: `${height * 0.6}px`,
